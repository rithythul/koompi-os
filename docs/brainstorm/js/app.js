...
var sectionFiles = [
  ...
  'sections/25-spatial-shell.html',
  ...
  'sections/78-village-commons.html',
  'sections/79-agent-diplomacy.html',
  'sections/80-the-gardener.html',
...
async function loadSections() {
  ...
  for (var i = 0; i < sectionFiles.length; i++) {
    try {
      var resp = await fetch(sectionFiles[i]);
