...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "deepseek-chat": aiModelComponent.createObject(this, {
            ...
            "description": Translation.tr("Online | %1's model | Strong general-purpose model with low pricing").arg("DeepSeek"),
            ...
            "key_get_description": Translation.tr("**Instructions**: Log into DeepSeek platform, open API keys, click Create new key"),
            "api_format": "openai",
        }),
        "glm-4.6": aiModelComponent.createObject(this, {
            "name": "GLM 4.6",
            "icon": "spark-symbolic",
            "description": Translation.tr("Online | %1's model | Strong reasoning and coding from the GLM series").arg("Z.ai"),
            "homepage": "https://z.ai",
            ...
            "key_get_description": Translation.tr("**Instructions**: Log into Z.ai, open API Keys, click Create new key"),
            "api_format": "openai",
        }),
        "minimax-m2": aiModelComponent.createObject(this, {
            "name": "MiniMax M2",
            "icon": "spark-symbolic",
            "description": Translation.tr("Online | %1's model | Long-context model with strong agentic abilities").arg("MiniMax"),
            "homepage": "https://www.minimax.io",
            "endpoint": "https://api.minimax.io/v1/chat/completions",
            "model": "MiniMax-M2",
            "requires_key": true,
            "key_id": "minimax",
            "key_get_link": "https://platform.minimax.io",
            "key_get_description": Translation.tr("**Instructions**: Log into MiniMax platform, open API Keys, click Create new key"),
            "api_format": "openai",
        }),
        "kimi-k2": aiModelComponent.createObject(this, {
            "name": "Kimi K2",
            "icon": "spark-symbolic",
            "description": Translation.tr("Online | %1's model | Strong agentic and coding model with long context").arg("Moonshot"),
            "homepage": "https://www.kimi.com",
            "endpoint": "https://api.moonshot.ai/v1/chat/completions",
            "model": "kimi-k2",
            "requires_key": true,
            "key_id": "moonshot",
            "key_get_link": "https://platform.kimi.ai/console/api-keys",
            "key_get_description": Translation.tr("**Instructions**: Log into the Kimi (Moonshot) platform, open API keys, click Create new key"),
            "api_format": "openai",
        }),
    }
